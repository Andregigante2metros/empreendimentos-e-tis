...
tis <- read_csv("Terras Indígenas em Estudo.csv")
...
ggplot() +
  ...
  geom_sf(data = tis_acre, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) + # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_alagoas, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_amapa, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_amazonas, fill = "darkgreen", color = "black", alpha = 0.6, size = 3) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_bahia, fill = "darkgreen", color = "black", alpha = 0.6, size = 3) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_ceara, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()

# TIS DO DISTRITO FEDERAL

tis_df <- tis |> 
  filter(uf_sigla %in% c("DF"))

plot(tis_df$the_geom)
...
ggplot() +
  ...
  geom_sf(data = tis_df, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_goias, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_maranhao, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_mt, fill = "darkgreen", color = "black", alpha = 0.6, size = 3) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_ms, fill = "darkgreen", color = "black", alpha = 0.6, size = 3) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_mg, fill = "darkgreen", color = "black", alpha = 0.6, size = 3) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_para, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_paraiba, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_parana, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_pernambuco, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
...
ggplot() +
  ...
  geom_sf(data = tis_rj, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()

# TIS DO RIO GRANDE DO NORTE

tis_rn <- tis |> 
  filter(uf_sigla %in% c("RN"))

plot(tis_rn$the_geom)
...
ggplot() +
  ...
  geom_sf(data = tis_rn, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_rs, fill = "darkgreen", color = "black", alpha = 0.6, size = 3) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_rondonia, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_roraima, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_sc, fill = "darkgreen", color = "black", alpha = 0.6, size = 3) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_sp, fill = "darkgreen", color = "black", alpha = 0.6, size = 3) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_sergipe, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
...
ggplot() +
  ...
  geom_sf(data = tis_tocantins, fill = "darkgreen", color = "black", alpha = 0.6, size = 4) +  # sobreposição TIs
  theme_minimal()
